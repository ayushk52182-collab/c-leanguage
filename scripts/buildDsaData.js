...
// Define the 14 modules and their detailed topics
const modulesData = [
  {
    id: "mod-1",
    moduleNumber: 1,
    ...
    topics: [
      {
        ...
        example: { input: "None (Conceptual)", output: "Welcome to Data Structures & Algorithms!" }
      },
      {
        id: "time-complexity",
        ...
        example: { input: "arr = [10, 20, 30, 40], n = 4", output: "10 20 30 40" }
      },
      {
        id: "space-complexity",
        ...
        example: { input: "[1, 2, 3]", output: "Copied: [1, 2, 3]" }
      },
      {
        id: "big-o-notation",
        ...
        example: { input: "n = 64", output: "6 steps" }
      },
      {
        id: "best-avg-worst",
        ...
        example: { input: "[4, 2, 7, 1, 9], target = 7", output: "Index = 2" }
      },
      {
        id: "recursion-basics",
    ...
    topics: [
      {
        ...
        example: { input: "[10, 20, 30, 40, 50], index = 2", output: "30" }
      },
      {
        id: "array-traversal",
        title: "Traversal",
        ...
        example: { input: "[2, 4, 6, 8, 10]", output: "Index 0: 2 ... Index 4: 10" }
      },
      {
        id: "array-insertion",
        title: "Insertion",
      ...
      },
      {
        ...
        example: { input: "[10, 20, 99, 30, 40], delete index 2", output: "[10, 20, 30, 40]" }
      },
      {
        id: "array-searching",
        title: "Searching",
        ...
        example: { input: "[1, 3, 5, 7, 9], target = 7", output: "Index = 3" }
      },
      {
        id: "prefix-sum",
        title: "Prefix Sum",
        ...
        example: { input: "arr = [2, 4, 1, 7, 5], L=1, R=3", output: "12" }
      },
      {
      ...
      },
      {
        ...
        example: { input: "arr = [1, 2, 3, 5, 8, 11], target = 10", output: "YES (2 + 8 = 10)" }
      },
      {
        id: "sliding-window",
        ...
        example: { input: "arr = [2, 1, 5, 1, 3, 2], k = 3", output: "9 (subarray [5, 1, 3])" }
      }
    ]
  },
  {
    ...
    topics: [
      {
        ...
        example: { input: "\"Hello DSA\"", output: "Length: 9, s[0]: H" }
      },
      {
        id: "string-traversal",
        ...
        example: { input: "\"algorithm\"", output: "3 vowels (a, o, i)" }
      },
      {
        ...
        example: { input: "\"coding\"", output: "\"gnidoc\"" }
      },
      {
        id: "palindrome-check",
        title: "Palindrome",
      ...
      },
      {
        ...
        example: { input: "\"engineering\"", output: "{'e': 3, 'n': 3, 'g': 2, 'i': 2, 'r': 1}" }
      },
      {
        id: "string-searching",
        ...
        example: { input: "text = \"hello world\", pattern = \"world\"", output: "Index = 6" }
      }
    ]
  },
  {
    ...
    topics: [
      {
        ...
        example: { input: "Create list: 10 -> 20 -> 30", output: "10 -> 20 -> 30 -> NULL" }
      },
      {
        id: "ll-insert",
        title: "Insert Node",
        ...
        example: { input: "Insert 10 then 20 at head", output: "10 -> 20 -> NULL" }
      },
      {
        id: "ll-delete",
        title: "Delete Node",
        ...
        example: { input: "10 -> 20 -> 30, delete 20", output: "10 -> 30 -> NULL" }
      },
      {
        id: "ll-reverse",
      ...
      },
      {
        ...
        example: { input: "1 -> 2 -> 3 -> 2 (cycle back)", output: "true" }
      },
      {
        ...
        example: { input: "NULL <- 10 <-> 20 -> NULL", output: "Bidirectional traversal verified" }
      },
      {
        ...
        example: { input: "10 -> 20 -> (back to 10)", output: "Head reached after 2 steps" }
      }
    ]
  },
  {
    ...
    topics: [
      {
        ...
        example: { input: "push(10), push(20), push(30), pop()", output: "Top = 20" }
      },
      {
        ...
        example: { input: "s.push(100), s.push(200)", output: "Top: 200, Popped: 200" }
      },
      {
        ...
        example: { input: "Visit Google -> GitHub -> Back", output: "Current: Google" }
      },
      {
    ...
    topics: [
      {
        ...
        example: { input: "q.enqueue(10), q.enqueue(20), q.dequeue()", output: "Remaining front = 20" }
      },
      {
        ...
        example: { input: "q.enqueue(5), q.enqueue(15)", output: "Front = 5" }
      },
      {
        id: "circular-queue",
        ...
        example: { input: "Circular ring buffer of size 3", output: "Full utilization without realloc" }
      },
      {
        id: "deque-concept",
        title: "Deque",
        ...
        example: { input: "push_front(5), push_back(10)", output: "Front: 5, Back: 10" }
      },
      {
        ...
        example: { input: "push(30), push(10), push(50)", output: "Max = 50" }
      }
    ]
  },
  {
    ...
    topics: [
      {
        ...
        example: { input: "ageMap[\"Alice\"] = 25", output: "25" }
      },
      {
        id: "hashmap",
        title: "HashMap",
        ...
        example: { input: "map[101] = \"Aayush\"", output: "\"Aayush\"" }
      },
      {
        id: "hashset",
        title: "HashSet",
        ...
        example: { input: "[1, 2, 2, 3, 3, 3]", output: "{1, 2, 3}" }
      },
      {
        id: "frequency-map",
        title: "Frequency Map",
        ...
        example: { input: "[4, 1, 2, 1, 2]", output: "Single number = 4" }
      },
      {
        ...
        example: { input: "Hash collision on keys 10 and 17 with mod 7", output: "Both stored in bucket 3 chain" }
      },
      {
        id: "hashing-problems",
        ...
        example: { input: "[2, 7, 11, 15], target = 9", output: "[0, 1] (nums[0] + nums[1] = 9)" }
      }
    ]
  },
  {
    ...
    topics: [
      {
        ...
        example: { input: "Root 1 with left child 2, right child 3", output: "1 -> (2, 3)" }
      },
      {
        id: "tree-terminology",
        ...
        example: { input: "A tree with 3 levels", output: "Height = 2 (edges)" }
      },
      {
        id: "bst-intro",
        ...
        example: { input: "Insert 50, 30, 70 into BST", output: "Root=50, Left=30, Right=70" }
      },
      {
        id: "tree-traversal",
        ...
        example: { input: "Tree nodes: 1, 2, 3", output: "Traversal covers all 3 nodes" }
      },
      {
        ...
        example: { input: "Root 1 (Left 2, Right 3)", output: "1 2 3" }
      },
      {
        ...
        example: { input: "Root 2 (Left 1, Right 3)", output: "1 2 3" }
      },
      {
        ...
        example: { input: "Root 1 (Left 2, Right 3)", output: "2 3 1" }
      },
      {
      ...
      },
      {
        ...
        example: { input: "Tree 1 -> 2 -> 3", output: "Height = 3 nodes (or 2 edges)" }
      },
      {
        ...
        example: { input: "Tree with root 3, left 5, right 1. p=5, q=1", output: "LCA = 3" }
      }
    ]
  },
  {
    ...
    topics: [
      {
        ...
        example: { input: "Heap array [50, 30, 40]", output: "Root=50, Left=30, Right=40" }
      },
      {
        id: "min-heap",
        title: "Min Heap",
        ...
        example: { input: "Push 30, 10, 20", output: "Min root = 10" }
      },
      {
        id: "max-heap",
        title: "Max Heap",
        ...
        example: { input: "Push 10, 50, 30", output: "Max root = 50" }
      },
      {
        ...
        example: { input: "[100, 500, 200]", output: "500 200 100" }
      },
      {
        id: "heap-sort",
        title: "Heap Sort",
      ...
      },
      {
        ...
        example: { input: "[3, 2, 1, 5, 6, 4], k = 2", output: "5 (2nd largest)" }
      }
    ]
  },
  {
    ...
    topics: [
      {
        ...
        example: { input: "Vertices A, B, C with edges (A-B), (B-C)", output: "Triangle network or path" }
      },
      {
        id: "adjacency-matrix",
        ...
        example: { input: "4 nodes, edge between 0 and 1", output: "matrix[0][1] = 1" }
      },
      {
        id: "adjacency-list",
        ...
        example: { input: "Node 1 connects to 0 and 2", output: "adj[1] = [0, 2]" }
      },
      {
        id: "bfs",
        title: "BFS",
        ...
        example: { input: "Graph: 0-(1,2), 2-3. Start=0", output: "0 1 2 3" }
      },
      {
        id: "dfs",
        title: "DFS",
        ...
        example: { input: "Graph starting at 0", output: "0 1 2 3 (branch-first)" }
      },
      {
        ...
        example: { input: "5 nodes with 2 separate groups + 1 isolated", output: "3 components" }
      },
      {
        ...
        example: { input: "Triangle graph (0-1, 1-2, 2-0)", output: "YES (Cycle detected)" }
      },
      {
        ...
        example: { input: "Source node S with edge weights", output: "Minimum distances array" }
      }
    ]
  },
  {
    ...
    topics: [
      {
        ...
        example: { input: "[10, 50, 30, 70], target = 30", output: "Index = 2" }
      },
      {
        id: "binary-search",
        title: "Binary Search",
      ...
      },
      {
        ...
        example: { input: "[10, 80, 30, 90, 40, 50, 70]", output: "[10, 30, 40, 50, 70, 80, 90]" }
      },
      {
        id: "counting-sort",
        title: "Counting Sort",
    ...
    topics: [
      {
        ...
        example: { input: "Greedy coin change with denominations [25, 10, 5, 1]", output: "Pick largest coin first" }
      },
      {
        ...
        example: { input: "6 activities with start and finish times", output: "4 non-overlapping activities" }
      },
      {
        ...
        example: { input: "W = 50, Items: (60,10), (100,20), (120,30)", output: "240.0" }
      },
      {
        id: "job-sequencing",
        ...
        example: { input: "Jobs with deadlines and profit", output: "Max profit scheduled" }
      },
      {
        ...
        example: { input: "6 train arrivals and departures", output: "3 platforms required" }
      }
    ]
  },
  {
    ...
    topics: [
      {
        ...
        example: { input: "Fibonacci recursive tree with redundant branches", output: "Cached in O(n) table" }
      },
      {
        id: "memoization",
        title: "Memoization",
        ...
        example: { input: "fib(10)", output: "55" }
      },
      {
        id: "tabulation",
        title: "Tabulation",
      ...
      },
      {
        ...
        example: { input: "n = 4 stairs", output: "5 ways" }
      },
      {
        id: "01-knapsack",
        title: "0/1 Knapsack",
        ...
        example: { input: "W = 50, wt = [10, 20, 30], val = [60, 100, 120]", output: "220" }
      },
      {
        id: "lcs",
        ...
        example: { input: "s1 = \"abcde\", s2 = \"ace\"", output: "3 (subsequence \"ace\")" }
      },
      {
        id: "lis",
        ...
        example: { input: "[10, 9, 2, 5, 3, 7, 101, 18]", output: "4 ([2, 3, 7, 101] or [2, 5, 7, 101])" }
      }
    ]
  },
  {
    ...
    topics: [
      {
        ...
        example: { input: "[1, 2, 3]", output: "6 permutations generated" }
      },
      {
        id: "trie",
        title: "Trie",
        ...
        example: { input: "insert(\"apple\"), search(\"apple\")", output: "true" }
      },
      {
        id: "bit-manipulation",
        ...
        example: { input: "[4, 1, 2, 1, 2]", output: "4 (via XOR cancelation)" }
      },
      {
        id: "dsu",
        ...
        example: { input: "union(0, 2), union(2, 4)", output: "0 and 4 connected = true" }
      },
      {
        id: "segment-tree",
        title: "Segment Tree",
        ...
        example: { input: "Range sum query [1, 3] on [1, 3, 5, 7, 9, 11]", output: "15 (3 + 5 + 7)" }
      },
      {
        ...
        example: { input: "DAG 0->1, 0->2, 1->3, 2->3", output: "Valid ordering: 0 1 2 3" }
      }
    ]
  }
];

// Helper to get total topic count and flattened list
const allLessons = modulesData.flatMap(m => m.topics.map(t => ({
  ...t,
  moduleId: m.id,
  moduleTitle: m.title,
...
const outputContent = `// Auto-generated comprehensive DSA Curriculum Data (14 Modules, ${allLessons.length} Topics)
export const DSA_MODULES = ${JSON.stringify(modulesData, null, 2)};
...
fs.writeFileSync(path.join(process.cwd(), 'src/data/dsaData.js'), outputContent);
console.log(`Successfully generated src/data/dsaData.js with ${modulesData.length} modules and ${allLessons.length} lessons!`);
